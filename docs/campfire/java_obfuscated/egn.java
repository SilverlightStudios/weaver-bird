...
import HolderLookup;
import NonNullList;
import component.DataComponentGetter;
import component.DataComponentMap;
import component.DataComponents;
import me;
...
implements Clearable {
    ...
    public egn(jh $$0, dvb $$1) {
        super(BlockEntityType.CAMPFIRE, $$0, $$1);
    }

    public static void cookTick(ServerLevel $$0, jh $$1, dvb $$22, egn $$3, RecipeManager.CachedCheck<SingleRecipeInput, CampfireCookingRecipe> $$4) {
        boolean $$5 = false;
        for (int $$6 = 0; $$6 < $$3.items.size(); ++$$6) {
            ...
            $$5 = true;
            int n2 = $$6;
            $$3.cookingProgress[n2] = $$3.cookingProgress[n2] + 1;
            ...
            Containers.dropItemStack((dhb)$$0, (double)$$1.getX(), (double)$$1.getY(), (double)$$1.getZ(), $$9);
            $$3.items.set($$6, ItemStack.EMPTY);
            $$0.sendBlockUpdated($$1, $$22, $$22, 3);
            $$0.gameEvent(GameEvent.BLOCK_CHANGE, $$1, GameEvent.Context.of($$22));
        }
        if ($$5) {
            egn.setChanged($$0, $$1, $$22);
        }
    }

    public static void cooldownTick(dhb $$0, jh $$1, dvb $$2, egn $$3) {
        boolean $$4 = false;
        ...
        if ($$4) {
            egn.setChanged($$0, $$1, $$2);
        }
    }

    public static void particleTick(dhb $$0, jh $$1, dvb $$2, egn $$3) {
        bcu $$4 = $$0.random;
        if ($$4.nextFloat() < 0.11f) {
            for (int $$5 = 0; $$5 < $$4.nextInt(2) + 2; ++$$5) {
                dvl.makeParticles($$0, $$1, $$2.getValue(dvl.SIGNAL_FIRE), false);
            }
        }
        int $$6 = $$2.getValue(dvl.FACING).get2DDataValue();
        for (int $$7 = 0; $$7 < $$3.items.size(); ++$$7) {
            ...
            for (int $$13 = 0; $$13 < 4; ++$$13) {
                $$0.addParticle(me.SMOKE, $$10, $$11, $$12, 0.0, 5.0E-4, 0.0);
            }
        }
    }
    ...
    @Override
    public void preRemoveSideEffects(jh $$0, dvb $$1) {
        if (this.level != null) {
