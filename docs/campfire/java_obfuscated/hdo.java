...
extends hcy {
    ...
    protected akj sprite;

    protected hdo(ghz $$0, double $$1, double $$2, double $$3, akj $$4) {
        super($$0, $$1, $$2, $$3);
        this.sprite = $$4;
        this.quadSize = 0.1f * (this.random.nextFloat() * 0.5f + 0.5f) * 2.0f;
    }

    protected hdo(ghz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, akj $$7) {
        super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
        this.sprite = $$7;
        this.quadSize = 0.1f * (this.random.nextFloat() * 0.5f + 0.5f) * 2.0f;
    }
    ...
    public void setSpriteFromAge(hdw $$0) {
        if (!this.removed) {
            this.setSprite($$0.get(this.age, this.lifetime));
        }
    }

    protected void setSprite(akj $$0) {
        this.sprite = $$0;
    }
