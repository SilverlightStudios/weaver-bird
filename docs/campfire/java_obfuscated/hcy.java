...
public abstract class hcy {
    ...
    protected final bcu random = bcu.create();
    protected int age;
    ...
    protected hcy(ghz $$0, double $$1, double $$2, double $$3) {
        this.level = $$0;
    ...
    public hcy(ghz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
        this($$0, $$1, $$2, $$3);
    ...
    protected int getLightColor(float $$0) {
        jh $$1 = jh.containing(this.x, this.y, this.z);
