 ...
 *
 * Parses OptiFine CEM animation expressions into an AST.
...
import { tokenize, PRECEDENCE, RIGHT_ASSOCIATIVE } from "./expressionTokenizer";

// Re-export tokenize for backward compatibility
export { tokenize };
